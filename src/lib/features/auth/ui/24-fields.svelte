<script lang="ts">
	...
	let waiting: string | undefined = undefined;
</script>
	...
	<div class="flex space-x-2">
		...
		>
			{#if waiting === 'tutor'}
				<svg
					role="status"
					class="w-[120px] h-6 text-gray-200 animate-spin dark:text-gray-600 fill-blue-500"
					viewBox="0 0 100 101"
					fill="none"
		...
		>
			{#if waiting === 'student'}
				<svg
					role="status"
					class="w-[140px] h-6 text-gray-200 animate-spin dark:text-gray-600 fill-blue-500"
					viewBox="0 0 100 101"
					fill="none"
					xmlns="http://www.w3.org/2000/svg"
				>
