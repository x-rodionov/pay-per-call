...
<article class="flex justify-between items-center py-4 border-b border-gray-400">
	...
	<div class="flex">
		<CTAButton class="mr-2" on:click={() => {
			dispatch('accept');
			waiting = true;
		}}>
			{#if waiting}
				<svg role="status" class="w-9 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-blue-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
